...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://gitlab.com/add003/artixrice.git"
[ -z "$progsfile" ] && progsfile="https://gitlab.com/add003/artixinst/-/raw/main/progs.csv"
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to add003's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-add003" 10 60
...
sudo -u "$name" mkdir -p "/home/$name/.local/share/go/src/gitlab.com/add003/"
sudo -u "$name" mkdir -p "/home/$name/.local/share/go/src/github.com/add1609/"
